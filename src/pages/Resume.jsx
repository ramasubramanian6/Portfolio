...
function Resume() {
  return (
    <div className='flex md:flex-row justify-between w-full h-80 flex-col bg-gradient-to-r from-white to to-blue-500 ' id='Resume'>
      <div className='pl-5 pt-12  pr-16 text-left '>
